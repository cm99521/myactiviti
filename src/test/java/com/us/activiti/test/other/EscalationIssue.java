...
public class EscalationIssue{

	Logger log = LoggerFactory.getLogger(EscalationIssue.class);
	@Autowired
	...
	public void executeJavaService() throws Exception {
		...
		HistoricFormProperty formProperty = (HistoricFormProperty) historyVariables
				.get(0);
		assertEquals("issueNo", formProperty.getPropertyId());
		assertEquals("3433454", formProperty.getPropertyValue());
